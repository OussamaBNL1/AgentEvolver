...
class UnifiedMixtureStrategy(MixtureStrategy):
    ...
    def __init__(self, use_original: bool = True, synthetic_ratio: float = 0.0, shuffle: bool = True):
        """
        Args:
        ...
        if self._synthetic_ratio > 0:
            ...
            if target_synthetic_count > 0:
                if target_synthetic_count > len(synthetic_objectives):
                    ...
                    selected_synthetic = random.sample(synthetic_objectives, target_synthetic_count)
    ...
    def __repr__(self):
        return f"UnifiedMixtureStrategy(use_original={self._use_original}, synthetic_ratio={self._synthetic_ratio}, shuffle={self._shuffle})"
