...
suffix="qwen25_14b_groupnorm_anni_nowarmup_qwenmax"
log_file="/mnt/data/taoshuchang.tsc/beyondagent/BeyondAgent/logs/w_qwen25/${suffix}_${current_time}.log"
llm_evaluation_log_dir="/mnt/data/taoshuchang.tsc/beyondagent/BeyondAgent/experiments/exp_${suffix}_${current_time}/llm_evaluation_logs"
...
python -m beyondagent.main_ppo \
    ...
    trainer.llm_evaluation_log_dir="$llm_evaluation_log_dir" \
    ...
    semantic_advantage.model='qwen-max' \
