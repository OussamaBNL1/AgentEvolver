...
log_file="logs/assignment/tsc_response_mask_debug_fixadv_sem_parallel_turbo_bad0.2_negbad-0.2_${current_time}.log"
...
python3 -m beyondagent.main_ppo \
    ...
    semantic_eval_mask_type=response_mask \
    ...
    trainer.experiment_name="qwen2.5-7b_appworld_tsc_response_mask_debug_fixadv_sem_parallel_turbo_assign_bad0.2_negbad-0.2_8gpu" \
    trainer.nnodes=1 \
    trainer.save_freq=-1 \
    trainer.test_freq=20 \
    trainer.total_epochs=20 \
    trainer.val_before_train=True \
    trainer.validation_data_dir="experiments/exp_tsc_response_mask_debug_fixadv_sem_parallel_turbo_assign_bad0.2_negbad-0.2${current_time}/validation_log" \
    trainer.rollout_data_dir="experiments/exp_tsc_response_mask_debug_fixadv_sem_parallel_turbo_assign_bad0.2_negbad-0.2${current_time}/rollout_log" \
