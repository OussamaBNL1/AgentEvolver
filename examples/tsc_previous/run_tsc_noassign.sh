# run on 4xH100 without semantic evaluation (no advantage assignment)
...
log_file="logs/assignment/tsc_baseline1_no_semantic_${current_time}.log"
...
python3 -m beyondagent.main_ppo \
    ...
    trainer.experiment_name="qwen2.5-7b_tsc_baseline1_no_semantic" \
    trainer.nnodes=1 \
    trainer.save_freq=20 \
    trainer.test_freq=20 \
    trainer.total_epochs=20 \
    trainer.val_before_train=True \
    trainer.validation_data_dir="experiments/exp_tsc_baseline1_no_semantic_${current_time}/validation_log" \
    trainer.rollout_data_dir="experiments/exp_tsc_baseline1_no_semantic_${current_time}/rollout_log" \
    ...
    experience_maker.workspace_id="w1_qwen25_baseline1_no_semantic_${current_time}" \
    2>&1 | tee "$log_file" \
    $@